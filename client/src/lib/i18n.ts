  ...
  en: {
    translation: {
      ...
      lectures: {
        ...
        noLecturesDescription: 'No lectures have been added to this unit yet. Create your first lecture to get started.',
        ...
        settingsDescription: 'Configure lecture duration and order',
        duration: 'Duration',
        order: 'Order',
        editLectureDescription: 'Update lecture content and settings',
        createLectureDescription: 'Add a new lecture to this unit',
      },
  ...
  ar: {
    translation: {
      ...
      lectures: {
        ...
        noLecturesDescription: 'لم يتم إضافة محاضرات إلى هذه الوحدة بعد. أنشئ محاضرتك الأولى للبدء.',
        deleteSuccess: 'تم حذف المحاضرة بنجاح',
        ...
        settingsDescription: 'تكوين مدة وترتيب المحاضرة',
        duration: 'المدة',
        order: 'الترتيب',
        editLectureDescription: 'تحديث محتوى وإعدادات المحاضرة',
        createLectureDescription: 'إضافة محاضرة جديدة إلى هذه الوحدة',
      },
  ...
  he: {
    translation: {
      ...
      lectures: {
        ...
        manageLectures: 'נהל הרצאות',
        createFirstLecture: 'צור הרצאה ראשונה',
        noLecturesDescription: 'לא נוספו הרצאות ליחידה זו עדיין. צור את ההרצאה הראשונה שלך כדי להתחיל.',
        deleteSuccess: 'ההרצאה נמחקה בהצלחה',
        deleteConfirmation: 'האם אתה בטוח שברצונך למחוק את "{{name}}"؟ פעולה זו אינה ניתנת לביטול.',
        hasVideo: 'מכיל וידאו',
        settings: 'הגדרות הרצאה',
        settingsDescription: 'קבע משך וסדר הרצאה',
        duration: 'משך',
        order: 'סדר',
        editLectureDescription: 'עדכן תוכן והגדרות הרצאה',
        createLectureDescription: 'הוסף הרצאה חדשה ליחידה זו',
      },
      ...
      messages: {
        ...
        lectureCreated: 'ההרצאה נוצרה בהצלחה',
        lectureUpdated: 'ההרצאה עודכנה בהצלחה',
        unitCreated: 'היחידה נוצרה בהצלחה',
        unitUpdated: 'היחידה עודכנה בהצלחה',
